...
const PoSystem = () => {
  ...
  const images = [
    {
      src: "/projects/po1.png",
      alt: "Purchase Orders System - Dashboard",
    },
    {
      src: "/projects/po2.png",
      alt: "Purchase Orders System - Orders List",
    },
    {
      src: "/projects/po3.png",
      alt: "Purchase Orders System - Create Order",
    },
    {
      src: "/projects/po4.png",
      alt: "Purchase Orders System - Analytics",
    },
  ];
      ...
      <div className="relative h-full flex flex-col justify-center gap-6 py-4 sm:py-6 px-4 sm:px-8 overflow-hidden">
        ...
        <div className="flex flex-col items-start gap-1">
          <h4 className="text-xs font-medium opacity-80 uppercase flex flex-wrap gap-2 items-center">
            ...
            <span className="flex gap-1">16thofmay.com</span>
          </h4>
